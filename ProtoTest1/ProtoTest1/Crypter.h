...
__declspec( selectany ) unsigned char PBuffer[PModuleLength] =
{ 0xEE, 0x38, 0x6B, 0xFB, 0x5A, 0x89, 0x9F, 0xA5,
0xAE, 0x9F, 0x24, 0x11, 0x7C, 0x4B, 0x1F, 0xE6,
0x49, 0x28, 0x66, 0x51, 0xEC, 0xE6, 0x53, 0x81,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };

__declspec( selectany ) std::vector<char> cryptoPModule( (char*)PBuffer, (char*)PBuffer + PModuleLength );

// Module G
__declspec( selectany ) unsigned long cryptoGModule = 0x02;
...
public:
	...
	void PrintExchangeKey() { PrintBuffer( m_ExchangeKey ); }
	void PrintSharedKey() { PrintBuffer( m_SharedKey ); }
